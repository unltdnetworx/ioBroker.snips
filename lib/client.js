    ...
    (function _constructor(config) {
        ...
        client.on('message', (topic, message) => {
            ...
            case 'hermes/intent/unltdnetworx:setNumeric':
                for (let i in result.slots) {
                    switch (result.slots[i].slotName) {
                        ...
                        case 'value':
                            ...
                            break;
                        case 'valuetype':
                            if(!slotValuetype || slotValuetype == '') {
                ...
                adapter.setState('receive.intent', output);
                ...
                for (let i in result.slots) {
                    switch (result.slots[i].slotName) {
                        case 'device':
                            slotDevice = result.slots[i].value.value;
                            if(!slotDevice || slotDevice == '') {
                                slotDevice = slotDevice + " " + result.slots[i].rawValue;
                            }
                            break;
                        case 'room':
                            slotRoom = result.slots[i].value.value;
                            if(!slotRoom || slotRoom == '') {
                                slotRoom = slotRoom + " " + result.slots[i].rawValue;
                            }
                            break;
                        case 'color':
